...
public class TypeLiteral<T> {
    ...
    public TypeLiteral<?> getFieldType(Field field) {
        checkArgument(field.getDeclaringClass().isAssignableFrom(rawType), "%s is not defined by a supertype of %s", field,
                      type);
    ...
    public List<TypeLiteral<?>> getParameterTypes(Member methodOrConstructor) {
        ...
        if (methodOrConstructor instanceof Method) {
            ...
            checkArgument(constructor.getDeclaringClass().isAssignableFrom(rawType), "%s does not construct a supertype of %s",
                          constructor, type);
    ...
    public TypeLiteral<?> getReturnType(Method method) {
        checkArgument(method.getDeclaringClass().isAssignableFrom(rawType), "%s is not defined by a supertype of %s", method,
                      type);
